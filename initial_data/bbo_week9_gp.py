...
def propose_query(X, y, func_idx):
    ...
    if func_idx == 4:      # Function 5: strong exploit
        n_global = 1000
        local_noise = 0.004
        xi = 0.0005
    elif func_idx == 7:    # Function 8: best but plateauing
        n_global = 2500
        local_noise = 0.012
        xi = 0.002
    elif func_idx == 6:    # Function 7: local refinement
        n_global = 3000
        local_noise = 0.012
        xi = 0.003
    elif func_idx == 1:    # Function 2: refine upper band
        n_global = 5000
        local_noise = 0.020
        xi = 0.006
    elif func_idx == 3:    # Function 4: refine stable good region
        n_global = 5000
        local_noise = 0.012
        xi = 0.004
    elif func_idx == 5:    # Function 6: recent improvement but noisy
        n_global = 12000
        local_noise = 0.050
        xi = 0.030
    elif func_idx == 0:    # Function 1: still weak signal
        n_global = 34000
        local_noise = 0.120
        xi = 0.200
    else:
...
def main():
    ...
    with open("week9_queries.txt", "w", encoding="utf-8") as f:
        for line in lines:
            f.write(line + "\n")

    print("\nSaved to week9_queries.txt")
