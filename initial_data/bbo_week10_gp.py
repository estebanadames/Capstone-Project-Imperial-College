...
week_outputs = [
    [
        ...
        1.2411689730836742e-151,
        2.8556640528793443e-181,
        2.8556640528793443e-181,
        4.406064392151042e-291,
        2.6065864278618756e-96,
        -2.7235622115428805e-117,
    ],
    [
        0.03838400221215603,
        0.5285960143922023,
    ...
    [
        ...
        -0.06816775168805957,
        -0.11790008081891142,
        -0.060846422227520666,
        -0.033794120314569416,
        -0.047564392250092985,
        -0.06524947624531895,
    ],
    [
        -11.923018749116093,
...
def propose_query(X, y, func_idx):
    ...
    if func_idx == 4:      # Function 5
        ...
        local_noise = 0.008
        xi = 0.001
    elif func_idx == 5:    # Function 6
        n_global = 5000
        local_noise = 0.020
        xi = 0.005
    elif func_idx == 3:    # Function 4
        n_global = 4000
        local_noise = 0.010
        xi = 0.003
    elif func_idx == 1:    # Function 2
        n_global = 12000
        local_noise = 0.050
        xi = 0.030
    elif func_idx == 2:    # Function 3
        n_global = 12000
        local_noise = 0.050
        xi = 0.030
    ...
    if local_candidates:
        ...
        X_candidates = global_candidates
...
def main():
    ...
    with open(os.path.join(BASE_DIR, "week10_queries.txt"), "w", encoding="utf-8") as f:
        for line in lines:
            f.write(line + "\n")

    print("\nSaved to week10_queries.txt")
