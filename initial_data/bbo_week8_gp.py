...
def propose_query(X, y, func_idx):
    ...
    if func_idx == 4:      # Function 5: exploit high-performing region
        n_global = 1500
        local_noise = 0.008
        xi = 0.001
    elif func_idx == 6:    # Function 7: return closer to best region
        n_global = 4000
        local_noise = 0.015
        xi = 0.004
        ...
        local_noise = 0.020
        xi = 0.006
    elif func_idx == 0:    # Function 1: still no useful signal
        n_global = 32000
        local_noise = 0.100
        xi = 0.200
    elif func_idx == 3:    # Function 4: refine around good region
        n_global = 6000
        local_noise = 0.020
        xi = 0.006
    elif func_idx == 5:    # Function 6: avoid latest poor region, explore moderately
        n_global = 18000
        local_noise = 0.050
        xi = 0.035
    else:
...
def main():
    ...
    with open("week8_queries.txt", "w", encoding="utf-8") as f:
        for line in lines:
            f.write(line + "\n")

    print("\nSaved to week8_queries.txt")
